...
namespace Hemnet\AgentBundle\Controller;
...
use Hemnet\AgentBundle\Entity\Agent;
use Hemnet\AgentBundle\Form\AgentType;
...
class AgentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HemnetAgentBundle:Agent')->findAll();
     ...
     * @Method("POST")
     * @Template("HemnetAgentBundle:Agent:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HemnetAgentBundle:Agent')->find($id);
     ...
     * @Method("PUT")
     * @Template("HemnetAgentBundle:Agent:edit.html.twig")
     */
