...
namespace Hemnet\HouseBundle\Controller;
...
use Hemnet\HouseBundle\Entity\House;
use Hemnet\HouseBundle\Form\HouseType;
...
class HouseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HemnetHouseBundle:House')->findAll();
     ...
     *
     * @Route("/", name="house_create")
     * @Method("POST")
     * @Template("HemnetHouseBundle:House:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HemnetHouseBundle:House')->find($id);
     ...
     *
     * @Route("/{id}", name="house_update")
     * @Method("PUT")
     * @Template("HemnetHouseBundle:House:edit.html.twig")
     */
